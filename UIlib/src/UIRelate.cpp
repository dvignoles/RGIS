...
static void _UIRelateFieldSelectButtonCBK(Widget widget, DBInt fieldCode, XmAnyCallbackStruct *callData) {
    ...
    switch (fieldType) {
        case DBTableFieldString:
            selection = UISelectObject(selectField, (DBObjectLIST<DBObject> *) itemTBL->Fields(), DBTableFieldIsString);
            break;
        case DBTableFieldInt:
            selection = UISelectObject(selectField, (DBObjectLIST<DBObject> *) itemTBL->Fields(),
                                       DBTableFieldIsInteger);
            break;
        default:
            selection = UISelectObject(selectField, (DBObjectLIST<DBObject> *) itemTBL->Fields(),
                                       DBTableFieldIsCategory);
            break;
    }
...
DBInt UIRelateData(DBObjData *data, DBObjRecord *relRec) {
    ...
    if (dShell == (Widget) NULL) {
        ...
        fieldTextF = XtVaCreateManagedWidget(((char *) UIRelateNameTextF) + 1, xmTextFieldWidgetClass, mainForm,
                                             ...
                                             NULL);
        XtAddCallback(fieldTextF, XmNvalueChangedCallback, (XtCallbackProc) _UIRelateNameChangedCBK,
                      (XtPointer) relateCLS.RelateNameSTR);
        ...
        dataField = XtVaCreateManagedWidget(((char *) UIRelateDataTextF) + 1, xmTextFieldWidgetClass, mainForm,
                                            ...
                                            NULL);
        XtAddCallback(dataField, XmNvalueChangedCallback, (XtCallbackProc) _UIRelateNameChangedCBK,
                      (XtPointer) relateCLS.DataNameSTR);
        ...
        fieldTextF = XtVaCreateManagedWidget(((char *) UIRelateFieldTextF) + 1, xmTextFieldWidgetClass, mainForm,
                                             ...
                                             NULL);
        XtAddCallback(fieldTextF, XmNvalueChangedCallback, (XtCallbackProc) _UIRelateNameChangedCBK,
                      (XtPointer) relateCLS.RelateFieldSTR);
        ...
        fieldTextF = XtVaCreateManagedWidget(((char *) UIRelateJoinFieldTextF) + 1, xmTextFieldWidgetClass, mainForm,
                                             ...
                                             NULL);
        XtAddCallback(fieldTextF, XmNvalueChangedCallback, (XtCallbackProc) _UIRelateNameChangedCBK,
                      (XtPointer) relateCLS.JoinFieldSTR);
