...
#define UICopyRightText "[Copyright (1994-2020) UNH - ASRC/CUNY]"
...
static XtResource _UIResources[] = {
        {(char *) "UILargeFontList",  XmCFontList, XmRFontList, sizeof(XmFontList), XtOffset (UIResData *,
                                                                                              LargeFontList),  NULL},
        {(char *) "UINormalFontList", XmCFontList, XmRFontList, sizeof(XmFontList), XtOffset (UIResData *,
                                                                                              NormalFontList), NULL},
        {(char *) "UISmallFontList",  XmCFontList, XmRFontList, sizeof(XmFontList), XtOffset (UIResData *,
                                                                                              SmallFontList),  NULL},
        {(char *) "UIItalicFontList", XmCFontList, XmRFontList, sizeof(XmFontList), XtOffset (UIResData *,
                                                                                              ItalicFontList), NULL},
        {(char *) "UIFixedFontList",  XmCFontList, XmRFontList, sizeof(XmFontList), XtOffset (UIResData *,
                                                                                              FixedFontList),  NULL}};
...
static void _UIMenuHelpButtonCBK(Widget widget, char *helpFile, XmAnyCallbackStruct *callData) {
    void UIMenuDisplayHelp(char *);
    UIMenuDisplayHelp(helpFile);
    widget = (Widget) NULL;
...
void UIMenuSensitive(unsigned group, int sensitive) {
    int i;
    for (i = 0; _UIMainMenu[i].Type != 0; ++i) _UIMainMenu[i].Sensitive(group, sensitive);
}

void UIMenuVisible(unsigned group, int sensitive) {
    int i;
    for (i = 0; _UIMainMenu[i].Type != 0; ++i) _UIMainMenu[i].Visible(group, sensitive);
}
