...
public:
    ...
    void Update() {
        ...
        switch (NewFieldPTR->Type()) {
            case DBTableFieldInt:
                OldFieldPTR->IntNoData(NewFieldPTR->IntNoData());
                break;
            case DBTableFieldFloat:
                OldFieldPTR->FloatNoData(NewFieldPTR->FloatNoData());
                break;
        }
    }
    ...
    void OrigField(DBObjectLIST<DBObjTableField> *fields) { OldFieldPTR = fields->Item(OldFieldPTR->Name()); }
...
static void UITableFieldSubFormIdleToggleCBK(Widget widget, DBObjTableField *field,
                                             XmToggleButtonCallbackStruct *callData) {
    field->Flags(DBObjectFlagIdle, callData->set ? DBSet : DBClear);
}

static void _UITableFieldSubFormWidthScaleCBK(Widget widget, UITableFieldSubForm *subForm,
                                              XmScaleCallbackStruct *callData) {
    subForm->FormatWidth(callData->value);
}

static void _UITableFieldSubFormDecimalScaleCBK(Widget widget, DBObjTableField *field,
                                                XmScaleCallbackStruct *callData) {
    if (field->Type() != DBTableFieldFloat) return;
    field->FormatDecimals(callData->value);
}

static void _UITableFieldSubFormNodataCBK(Widget widget, UITableFieldSubForm *subForm,
                                          XmTextVerifyCallbackStruct *callData) {
    char *string;

    if (callData->reason != XmCR_LOSING_FOCUS) return;
    if ((string = XmTextFieldGetString(widget)) != (char *) NULL) {
        subForm->Nodata(string);
        XtFree(string);
    }
}
...
UITableFieldSubForm::UITableFieldSubForm(Widget parent, DBObjTableField *field) {
    ...
    SizeButtonWGTs[0] = XtVaCreateManagedWidget("UITableFieldSubFormSizeByteButton", xmPushButtonGadgetClass,
                                                SizeMenuWGT,
                                                XmNlabelString, string,
                                                XmNuserData, this,
                                                NULL);
    XmStringFree(string);
    XtAddCallback(SizeButtonWGTs[0], XmNactivateCallback, (XtCallbackProc) _UITableFieldSubFormSizeButtonCBK,
                  (XtPointer) sizeof(DBByte));
    string = XmStringCreate((char *) "Short", UICharSetNormal);
    SizeButtonWGTs[1] = XtVaCreateManagedWidget("UITableFieldSubFormSizeShortButton", xmPushButtonGadgetClass,
                                                SizeMenuWGT,
                                                XmNlabelString, string,
                                                XmNuserData, this,
                                                NULL);
    XmStringFree(string);
    XtAddCallback(SizeButtonWGTs[1], XmNactivateCallback, (XtCallbackProc) _UITableFieldSubFormSizeButtonCBK,
                  (XtPointer) sizeof(DBShort));
    string = XmStringCreate((char *) "Long", UICharSetNormal);
    SizeButtonWGTs[2] = XtVaCreateManagedWidget("UITableFieldSubFormSizeLongButton", xmPushButtonGadgetClass,
                                                SizeMenuWGT,
                                                XmNlabelString, string,
                                                XmNuserData, this,
                                                NULL);
    XmStringFree(string);
    XtAddCallback(SizeButtonWGTs[2], XmNactivateCallback, (XtCallbackProc) _UITableFieldSubFormSizeButtonCBK,
                  (XtPointer) sizeof(DBInt));
    ...
    TypeButtonWGTs[0] = XtVaCreateManagedWidget("UITableFieldSubFormCharButton", xmPushButtonGadgetClass, TypeMenuWGT,
                                                ...
                                                NULL);
    XmStringFree(string);
    XtAddCallback(TypeButtonWGTs[0], XmNactivateCallback, (XtCallbackProc) _UITableFieldSubFormTypeButtonCBK,
                  (XtPointer) DBTableFieldString);
    ...
    TypeButtonWGTs[1] = XtVaCreateManagedWidget("UITableFieldSubFormIntButton", xmPushButtonGadgetClass, TypeMenuWGT,
                                                ...
                                                NULL);
    XmStringFree(string);
    XtAddCallback(TypeButtonWGTs[1], XmNactivateCallback, (XtCallbackProc) _UITableFieldSubFormTypeButtonCBK,
                  (XtPointer) DBTableFieldInt);
    ...
    TypeButtonWGTs[2] = XtVaCreateManagedWidget("UITableFieldSubFormFloatButton", xmPushButtonGadgetClass, TypeMenuWGT,
                                                ...
                                                NULL);
    XmStringFree(string);
    XtAddCallback(TypeButtonWGTs[2], XmNactivateCallback, (XtCallbackProc) _UITableFieldSubFormTypeButtonCBK,
                  (XtPointer) DBTableFieldFloat);
    ...
    TypeButtonWGTs[3] = XtVaCreateManagedWidget("UITableFieldSubFormDateButton", xmPushButtonGadgetClass, TypeMenuWGT,
                                                ...
                                                NULL);
    XmStringFree(string);
    XtAddCallback(TypeButtonWGTs[3], XmNactivateCallback, (XtCallbackProc) _UITableFieldSubFormTypeButtonCBK,
                  (XtPointer) DBTableFieldDate);
    ...
    XtAddCallback(NameWGT, XmNvalueChangedCallback, (XtCallbackProc) _UITableFieldSubFormNameCBK,
                  (XtPointer) NewFieldPTR);
    ...
    DecimalsSWGT = XtVaCreateManagedWidget("UITableFieldSubFormDecimalsScale", xmScaleWidgetClass, SubFormWGT,
                                           ...
                                           XmNtraversalOn, false,
                                           NULL);
    XtAddCallback(DecimalsSWGT, XmNdragCallback, (XtCallbackProc) _UITableFieldSubFormDecimalScaleCBK,
                  (XtPointer) NewFieldPTR);
    ...
    IdleWGT = XtVaCreateManagedWidget("UITableRedefineFieldNameFieldToggle", xmToggleButtonGadgetClass, SubFormWGT,
                                      ...
                                      XmNtraversalOn, false,
                                      NULL);
    XtAddCallback(IdleWGT, XmNvalueChangedCallback, (XtCallbackProc) UITableFieldSubFormIdleToggleCBK,
                  (XtPointer) NewFieldPTR);
    XmStringFree(string);
        ...
        case DBTableFieldInt:
            ...
            switch (NewFieldPTR->Length()) {
                ...
                case sizeof(DBShort):
                    ...
                    break;
                case sizeof(DBInt):
                    XtSetSensitive(SizeButtonWGTs[2], true);
                    break;
            }
            break;
        case DBTableFieldFloat:
...
DBInt UITableRedefineFields(DBObjTable *table) {
    ...
    for (fieldSubForm = fieldSubFormList->First();
         fieldSubForm != (UITableFieldSubForm *) NULL; fieldSubForm = fieldSubFormList->Next())
                ...
                for (recordID = 0; recordID < table->ItemNum(); recordID++) {
                    ...
                    switch (newField->Type()) {
                        ...
                        case DBTableFieldCoord:
                            newField->Coordinate(dstRecord, oldField->Coordinate(srcRecord));
                            break;
                        case DBTableFieldRegion:
                            newField->Region(dstRecord, oldField->Region(srcRecord));
                            break;
                        case DBTableFieldPosition:
                            newField->Position(dstRecord, oldField->Position(srcRecord));
                            break;
                        case DBTableFieldTableRec:
                        case DBTableFieldDataRec:
                            newField->Record(dstRecord, oldField->Record(srcRecord));
                            break;
                    }
                }
            }
