...
static void _CMDprintUsage (const char *arg0) {
    ...
    CMmsgPrint(CMmsgInfo,     "     -T, --target    [targe grid]");
    CMmsgPrint(CMmsgUsrError, "     -m, --mode      [deficit|surplus]");
    CMmsgPrint(CMmsgInfo,     "     -o, --output    [storage grid]");
...
int main(int argc, char *argv[]) {
    int argPos, argNum = argc, ret, verbose = false, deficit = true;
    char *title  = (char *) NULL, *subject = (char *) NULL;
    char *domain = (char *) NULL, *version = (char *) NULL;
    char *output = (char *) NULL,  *target = (char *) NULL;
...
Help:   if (CMargTest (argv[argPos], "-h", "--help")) {
    ...
    if (grdData->Read(target) == CMfailed) { delete grdData; return (CMfailed); }
