...
static VDBmasterTable_t _VDBmasterTable3 [] = {
        ...
        {"radiation",     "radiation_longwave_clear_sky",                 "Radiation-Longwave-ClearSky",                  "Clear Sky Longwave Radiation",         VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_longwave_downwelling",               "Radiation-Longwave-Downwelling",               "Downwelling Longwave Radiation",       VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_longwave_upwelling",                 "Radiation-Longwave-Upwelling",                 "Upwelling Longwave Radiation",         VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_shortwave_clear_sky",                "Radiation-Shortwave-ClearSky",                 "Clear Sky Shortwave Radiation",        VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_shortwave_downwelling",              "Radiation-Shortwave-Downwelling",              "Downwelling Shortwave Radiation",      VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_shortwave_upwelling",                "Radiation-Shortwave-Upwelling",                "Upwelling Shortwave Radiation",        VDBcontinuous, VDBgrey,          VDBsum},
        {"reservoir",     "reservoir_area",                               "Reservoir-Area",                               "Reservoir Area",                        VDBcontinuous, VDBgrey,          VDBsum},
        {"reservoir",     "reservoir_capacity",                           "Reservoir-Capacity",                           "Reservoir Capacity",                    VDBcontinuous, VDBgrey,          VDBsum},
        {"reservoir",     "reservoir_dam",                                "Reservoir-Dam",                                "Reservoir Dam",                         VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        {"reservoir",     "reservoir_height",                             "Reservoir-Height",                             "Reservoir Height",                      VDBcontinuous, VDBgrey,          VDBavg},
