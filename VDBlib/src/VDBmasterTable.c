...
static VDBmasterTable_t _VDBmasterTable2 [] = {
        ...
        {"hydrography",     "daily_precipitation_fraction",      "Precipitation-DailyFraction",     "Daily Precipitation Fraction",      "continuous", "grey",        "avg"},
        {"hydrography",     "discharge",                         "Discharge",                       "Discharge",                         "continuous", "blue",        "avg"},
        {"hydrography",     "evapotranspiration",                "Evapotranspiration",              "Evapotranspiration",                "continuous", "grey",        "sum"},
        {"hydrography",     "potential_evapotranspiration",      "PotEvapotranspiration",           "Potential Evapotranspiration",      "continuous", "grey",        "sum"},
        {"hydrography",     "precipitation",                     "Precipitation",                   "Precipitation",                     "continuous", "blue",        "sum"},
        {"hydrography",     "rainfall",                          "Rainfall",                        "Rainfall",                          "continuous", "blue",        "sum"},
        {"hydrography",     "rain_pet",                          "RainPET",                         "Rain Potential ET",                 "continuous", "blue",        "sum"},
        {"hydrography",     "runoff",                            "Runoff",                          "Runoff",                            "continuous", "blue",        "avg"},
        {"hydrography",     "snowfall",                          "SnowFall",                        "Snowfall",                          "continuous", "blue",        "sum"},
        {"hydrography",     "soil_moisture",                     "SoilMoisture",                    "Soil Moisture",                     "continuous", "grey",        "avg"},
        {"hydrography",     "soil_moisture_change",              "SoilMoistureChange",              "Soil Moisture Change",              "continuous", "grey",        "avg"},
...
static VDBmasterTable_t _VDBmasterTable3 [] = {
        ...
        {"hydrography",   "hydrography_discharge",                             "Hydrography-Discharge",                        "Discharge",                          "continuous", "blue",        "avg"},
        {"hydrography",   "hydrography_drought_index_palmer",                  "Hydrography-DroughtIndex-Palmer",              "Palmer Drought Index",               "continuous", "blue",        "avg"},
        {"hydrography",   "hydrography_evapotranspiration",                    "Hydrography-Evapotranspiration",               "Evapotranspiration",                 "continuous", "grey",        "sum"},
        {"hydrography",   "hydrography_evapotranspiration_deficit",            "Hydrography-Evapotranspiration-Deficit",       "Water Deficit",                      "continuous", "grey",        "sum"},
        {"hydrography",   "hydrography_evapotranspiration_potential",          "Hydrography-Evapotranspiration-Potential",     "Potential Evapotranspiration",       "continuous", "grey",        "sum"},
        {"hydrography",   "hydrography_evapotranspiration_potential_land",     "Hydrography-Evapotranspiration-PotentialLand", "Potenital Evapotranspiration - Land","continuous", "blue",        "sum"},
        {"hydrography",   "hydrography_evapotranspiration_potential_crop",     "Hydrography-Evapotranspiration-PotentialCrop", "Potential Evapotranspiration - Crop","continuous", "blue",        "sum"},
        {"hydrography",   "hydrography_precipitation",                         "Hydrography-Precipitation",                    "Precipitation",                      "continuous", "blue",        "sum"},
        {"hydrography",   "hydrography_precipitation_daily_fraction",          "Hydrography-Precipitation-DailyFraction",      "Daily Precipitation Fraction",       "continuous", "grey",        "avg"},
        {"hydrography",   "hydrography_precipitation_rainfall",                "Hydrography-Precipitation-Rainfall",           "Precipitation",                      "continuous", "blue",        "sum"},
        {"hydrography",   "hydrography_precipitation_snowfall",                "Hydrography-Precipitation-Snowfall",           "Snowfall",                           "continuous", "blue",        "sum"},
        {"hydrography",   "hydrography_runoff",                                "Hydrography-Runoff",                           "Runoff",                             "continuous", "blue",        "avg"},
        {"hydrography",   "hydrography_runoff_surface",                        "Hydrography-Runoff-Surface",                   "Surface Runoff",                     "continuous", "blue",        "avg"},
        {"hydrography",   "hydrography_runoff_subsurface",                     "Hydrography-Runoff-Subsurface",                "Subsurface Runoff",                  "continuous", "blue",        "avg"},
        {"hydrography",   "hydrography_snow_water_equivalent",                 "Hydrography-Snow-WaterEquivalent",             "Snow Water Equivalent",              "continuous", "blue",        "avg"},
        {"hydrography",   "hydrography_soil_moisture",                         "Hydrography-SoilMoisture",                     "Soil Moisture",                      "continuous", "grey",        "avg"},
        {"hydrography",   "hydrography_soil_moisture_change",                  "Hydrography-SoilMoisture-Change",              "Soil Moisture Change",               "continuous", "grey",        "avg"},
        ...
        {"topography",    "topography_elevation-max",                          "Topography-Elevation-Max",                     "Maximum Elevation",                  "continuous", "elevation",   "avg"},
