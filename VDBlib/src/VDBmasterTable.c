...
static VDBmasterTable_t _VDBmasterTable2 [] = {
        ...
        {"energy",        "hydropower_plant",                  "HydroPower-Plant",                "Hydro Power Plant",                     VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        {"energy",        "hydropower_subbasin",               "HydroPower-Subbasin",             "Hydro Power Subbasin",                  VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
        {"energy",        "thermalpower_plant",                "ThermalPower-Plant",              "Thermal Power Plant",                   VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        {"energy",        "thermalpower_subbasin",             "ThermalPower-Subbasin",           "Thermal Power Subbasin",                VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
        {"energy",        "electricity_region",                "Electricity-Region",              "Electricity Balancing Region",          VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
        {"energy",        "electricity_region_crossing",       "Electricity-RegionCrossing",      "Electricity Balancing Region Crossing", VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        ...
        {"hydrography",   "discharge_gauge",                   "DischargeGauge",                  "Discharge Gauge",                       VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        {"hydrography",   "discharge_subbasin",                "Discharge-Subbasin",              "Discharge Subbasin",                    VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
        ...
        {"radiation",     "longwave_clear_sky_radiation",      "Radiation-LongWave-ClearSky",     "Clear Sky Long Wave Radiation",         VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "longwave_downwelling_radiation",    "Radiation-LongWave-Downwelling",  "Downwelling Long Wave Radiation",       VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "longwave_upwelling_radiation",      "Radiation-LongWave-Upwelling",    "Upwelling Long Wave Radiation",         VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "shortwave_clear_sky_radiation",     "Radiation-ShortWave-ClearSky",    "Clear Sky Short Wave Radiation",        VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "shortwave_downwelling_radiation",   "Radiation-ShortWave-Downwelling", "Downwelling Short Wave Radiation",      VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "shortwave_upwelling_radiation",     "Radiation-ShortWave-Upwelling",   "Upwelling Short Wave Radiation",        VDBcontinuous, VDBgrey,          VDBavg},
        ...
        {"reservoir",     "reservoir_irrigation_demand",       "Reservoir-IrrigationDemand",      "Reservoir Irrigation Water Demand",     VDBcontinuous, VDBgrey,          VDBsum},
        {"reservoir",     "reservoir_nonirrigation_demand",    "Reservoir-NonIrrigationDemand",   "Reservoir Non-Irrigation Water Demand", VDBcontinuous, VDBgrey,          VDBsum},
        ...
        {"river",         "river_temperature",                 "River-Temperature",               "River Temperature",                     VDBcontinuous, VDBblue2red,      VDBavg},
        {"river",         "river_temperature_gauge",           "River-Temperature-Gauge",         "River Temperature Gauge",               VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        {"river",         "river_temperature_subbasin",        "River-Temperature-Subbasin",      "River Temperature Subbasin",            VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
        {"river",         "river_slope",                       "Slope",                           "Slope",                                 VDBcontinuous, VDBelevation,     VDBavg},
        {"river",         "river_slope-min",                   "Slope-Min",                       "Minimum River Slope",                   VDBcontinuous, VDBelevation,     VDBavg},
        {"river",         "river_slope-max",                   "Slope-Max",                       "Maximum River Slope",                   VDBcontinuous, VDBelevation,     VDBavg},
        ...
        {"topography",    "elevation_max",                     "Elevation-Max",                   "Maximum Elevation",                     VDBcontinuous, VDBelevation,     VDBavg},
        {"topography",    "elevation_min",                     "Elevation-Min",                   "Minimum Elevation",                     VDBcontinuous, VDBelevation,     VDBavg}};
...
static VDBmasterTable_t _VDBmasterTable3 [] = {
        ...
        {"energy",        "energy_hydropower_plant",                      "Energy-HydroPower-Plant",                      "Hydropower Plant",                      VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        ...
        {"energy",        "energy_electricity_region",                    "Energy-Electricity-Region",                    "Electricity Balancing Region",          VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
        {"energy",        "energy_electricity_region_crossing",           "Energy-Electricity-RegionCrossing",            "Electricity Balancing Region Crossing", VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
        ...
        {"hydrography",   "hydrography_discharge_gauge",                  "Hydrography-Discharge-Gauge",                  "Discharge Gauge",                       VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        {"hydrography",   "hydrography_discharge_subbasin",               "Hydrography-Discharge-Subbasin",               "Discharge Subbasin",                    VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
        ...
        {"radiation",     "radiation_longwave_clear_sky",                 "Radiation-LongWave-ClearSky",                  "Clear Sky Long Wave Radiation",         VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_longwave_downwelling",               "Radiation-LongWave-Downwelling",               "Downwelling Long Wave Radiation",       VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_longwave_upwelling",                 "Radiation-LongWave-Upwelling",                 "Upwelling Long Wave Radiation",         VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_shortwave_clear_sky",                "Radiation-ShortWave-ClearSky",                 "Clear Sky Short Wave Radiation",        VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_shortwave_downwelling",              "Radiation-ShortWave-Downwelling",              "Downwelling Short Wave Radiation",      VDBcontinuous, VDBgrey,          VDBsum},
        {"radiation",     "radiation_shortwave_upwelling",                "Radiation-ShortWave-Upwelling",                "Upwelling Short Wave Radiation",        VDBcontinuous, VDBgrey,          VDBsum},
        {"reservoir",     "reservoir_area",                               "Reservoir-Area",                               "Reservoir Area",                        VDBcontinuous, VDBgrey,          VDBsum},
        {"reservoir",     "reservoir_capacity",                           "Reservoir-Capacity",                           "Reservoir Capacity",                    VDBcontinuous, VDBgrey,          VDBsum},
        {"reservoir",     "reservoir_dam",                                "Reservoir-Dam",                                "Reservoir Dam",                         VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        {"reservoir",     "reservoir_height",                             "Reservoir-Height",                             "Reservoir Height",                      VDBcontinuous, VDBgrey,          VDBavg},
        ...
        {"river",         "river_slope"         ,                         "River-Slope",                                  "River Slope",                           VDBcontinuous, VDBelevation,     VDBavg},
        {"river",         "river_slope-min",                              "River-Slope-Min",                              "Minimum River Slope",                   VDBcontinuous, VDBelevation,     VDBavg},
        {"river",         "river_slope-max",                              "River-Slope-Max",                              "Maximum River Slope",                   VDBcontinuous, VDBelevation,     VDBavg},
        {"river",         "river_temperature",                            "River-Temperature",                            "River Temperature",                     VDBcontinuous, VDBblue2red,      VDBavg},
        {"river",         "river_temperature_gauge",                      "River-Temperature-Gauge",                      "River Temperature Gauge",               VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        {"river",         "river_temperature_subbasin",                   "River-Temperature-Subbasin",                   "River Temperature Subbasin",            VDBdiscrete,   VDBnotApplicable, VDBnotApplicable},
