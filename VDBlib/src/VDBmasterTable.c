...
static VDBmasterTable_t _VDBmasterTable [] = {
        ...
        {"soil",          "bulk_density",                      "BulkDensity",                     "Bulk Density",                      "continuous", "grey",         "avg"},
        ...
        {"soil",          "clay_percent_by_weight",            "Soil-ClayPercentByWeight",        "Percent Clay by Weight",            "continuous", "grey",         "avg"},
        ...
        {"soil",          "silt_percent_by_weight",            "Soil-SiltPercentByWeight",        "Percent Silt by Weight",            "continuous", "grey",         "avg"},
