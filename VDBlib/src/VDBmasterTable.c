...
static VDBmasterTable_t _VDBmasterTable2 [] = {
        ...
        {"river",         "river_slope",                       "RiverSlope",                      "Slope",                                 VDBcontinuous, VDBelevation,     VDBavg},
        {"river",         "river_slope-min",                   "RiverSlope-Min",                  "Minimum River Slope",                   VDBcontinuous, VDBelevation,     VDBavg},
        {"river",         "river_slope-max",                   "RiverSlope-Max",                  "Maximum River Slope",                   VDBcontinuous, VDBelevation,     VDBavg},
