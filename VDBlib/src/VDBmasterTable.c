...
static VDBmasterTable_t _VDBmasterTable2 [] = {
        ...
        {"radiation",     "longwave_clear_sky_radiation",      "Radiation-Longwave-ClearSky",     "Clear Sky Longwave Radiation",          VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "longwave_downwelling_radiation",    "Radiation-Longwave-Downwelling",  "Downwelling Longwave Radiation",        VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "longwave_upwelling_radiation",      "Radiation-Longwave-Upwelling",    "Upwelling Longwave Radiation",          VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "shortwave_clear_sky_radiation",     "Radiation-Shortwave-ClearSky",    "Clear Sky Shortwave Radiation",         VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "shortwave_downwelling_radiation",   "Radiation-Shortwave-Downwelling", "Downwelling Shortwave Radiation",       VDBcontinuous, VDBgrey,          VDBavg},
        {"radiation",     "shortwave_upwelling_radiation",     "Radiation-Shortwave-Upwelling",   "Upwelling Shortwave Radiation",         VDBcontinuous, VDBgrey,          VDBavg},
