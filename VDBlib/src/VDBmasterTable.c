...
static VDBmasterTable_t _VDBmasterTable3 [] = {
        ...
        {"topography",    "topography-bathymetry",                             "Topography-Bathymetry",                      "Bathymetry",                         "continuous", "blue",        "avg"},
        {"topography",    "topography-bathymetry_min",                         "Topography-Bathymetry-Min",                  "Minimum Depth",                      "continuous", "blue",        "avg"},
        {"topography",    "topography-bathymetry_max",                         "Topography-Bathymetry-Max",                  "Maximum Depth",                      "continuous", "blue",        "avg"},
        {"topography",    "topography-elevation",                              "Topography-Elevation",                       "Elevation",                          "continuous", "elevation",   "avg"},
        {"topography",    "topography-elevation_min",                          "Topography-Elevation-Min",                   "Minimum Elevation",                  "continuous", "elevation",   "avg"},
        {"topography",    "topograpgy-elevation_max",                          "Topography-Elevation-Max",                   "Maximum Elevation",                  "continuous", "elevation",   "avg"},
