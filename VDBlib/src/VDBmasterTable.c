...
static VDBmasterTable_t _VDBmasterTable3 [] = {
        ...
        {"topography",    "topography-min_elevation",                          "Topography-Elevation-Min",                   "Minimum Elevation",                  "continuous", "elevation",   "avg"},
        {"topography",    "topograpgy-max_elevation",                          "Topography-Elevation-Max",                   "Maximum Elevation",                  "continuous", "elevation",   "avg"},
