...
function _GPKGattribTable () {
	...
	echo "DROP TABLE \"rtree_${schemaName}_${tableName}_geom_geom_node\";"
	echo "DROP TABLE \"rtree_${schemaName}_${tableName}_geom_geom_parent\";"
	echo "DROP TABLE \"rtree_${schemaName}_${tableName}_geom_geom_rowid\";"
