...
function _GPKGattribTable () {
	...
	echo "DROP TABLE \"rtree_${schemaName}_${tableName}_geom\""
	echo "DROP TABLE \"rtree_${schemaName}_${tableName}_geom_node\""
	echo "DROP TABLE \"rtree_${schemaName}_${tableName}_geom_parent\""
	echo "DROP TABLE \"rtree_${schemaName}_${tableName}_geom_rowid\""
